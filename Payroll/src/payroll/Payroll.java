 ...
 * what would represent both the state and the behavior of 
 * the PayRoll class.
...
private void run()
{
  ...
  while (shouldContinue)
  {
    ...
    {
        System.out.println("Please enter a bonus for manger");
    ...
    {
        System.out.println("Do want to create a partTime Employee?");
        String partTime=sc.nextLine();
        if(partTime.equals("yes"))

        {
            PartTimeEmployee emp=new PartTimeEmployee(name,numHours,wage);
